  ...
  <div>
    ...
    <div className=' items-center w-full px-5 py-7 md:px-12 md:py-14 font-Inter lg:px-20 lg:py-1'>
      ...
      <div className="flex justify-center pb-5 md:pb-10">
        <img src={fair} alt="fair" className='w-60'/>
        </div>
      ...
      />
              ...
              <span  onClick={togglePasswordVisibilty} className='absolute right-4 top-1/2 transform-translate-y-1/2 cursor-pointer dark:bg-black dark:text-white '>
                {showPassword ? (
            ...
            <a href= "/Dashboard"  className='flex justify-center mt-10 text-center transform -translate-y-1/2 bg-black text-white dark:bg-green-500 dark:text-white hover:opacity-50 hover:text-white rounded-md px-2 py-2'
